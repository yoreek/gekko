...
constexpr uint32_t kDht11BitThresholdMicros = 50U;
...
bool dht11CaptureMeasurement(IDht11LineDriver& driver, uint8_t pin, int32_t& milliCelsius, int32_t& milliPercent, const char*& errorStatus);
