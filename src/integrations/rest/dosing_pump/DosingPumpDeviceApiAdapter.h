...
class DosingPumpDeviceApiAdapter final
    : public TypedDeviceApiAdapter<DosingPumpDeviceApiAdapter, DosingPumpDevice, DosingPumpDeviceConfigV1> {
public:
    static constexpr const char* kTypeName = "dosing_pump";

    bool parseCreateExtras(const JsonObjectConst& input, const JsonObjectConst& configInput, DosingPumpDeviceConfigV1& config,
                           DeviceCreateRequest& request, const char*& error) const;
    bool parseUpdateExtras(const JsonObjectConst& input, const JsonObjectConst& configInput, DosingPumpDeviceConfigV1& config,
                           DeviceConfigUpdateRequest& request, const char*& error) const;
    void writeRuntimeJson(const DosingPumpDevice& device, JsonObject runtimeJson) const;
