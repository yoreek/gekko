...
class Dht11SensorDeviceApiAdapter final
    : public TypedDeviceApiAdapter<Dht11SensorDeviceApiAdapter, Dht11SensorDevice, Dht11SensorConfigV3> {
public:
    static constexpr const char* kTypeName = "dht11";

    bool parseCreateExtras(const JsonObjectConst& input, const JsonObjectConst& configInput, Dht11SensorConfigV3& config,
                           DeviceCreateRequest& request, const char*& error) const;
    bool parseUpdateExtras(const JsonObjectConst& input, const JsonObjectConst& configInput, Dht11SensorConfigV3& config,
