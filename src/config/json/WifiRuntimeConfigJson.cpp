...
void WifiRuntimeConfigJson::write(JsonDocument& doc, const WifiRuntimeConfig& config) {
    ...
    runtime["fallback_ap_enabled"] = config.fallbackApEnabled;
}
...
void WifiRuntimeConfigJson::read(JsonDocument& doc, DeviceConfig& config) {
    ...
    config.wifiRuntime.fallbackApEnabled = runtime["fallback_ap_enabled"] | config.wifiRuntime.fallbackApEnabled;
}
