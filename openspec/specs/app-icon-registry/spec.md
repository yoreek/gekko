...
Define the shared icon resolution layer for the portal SPA, including the semantic naming scheme, the split between local domain icons and selected `@mdi/js` icons, and the bundle-size constraints that keep the frontend lightweight.
