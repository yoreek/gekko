...
int main(int, char**) {
    ...
    RUN_TEST(test_dht11_device_publishes_temperature_and_humidity_from_single_wire_frame);
    RUN_TEST(test_dht11_device_faults_after_repeated_invalid_frames);
    RUN_TEST(test_dht11_api_adapter_rejects_dependencies_and_writes_runtime_json);
    RUN_TEST(test_dht11_schema_contracts_cover_config_and_response_shapes);
    ...
    RUN_TEST(test_st7735_display_profile_swaps_bounds_on_quarter_rotation);
    RUN_TEST(test_st7735_layout_validation_respects_rotated_bounds);
    ...
    RUN_TEST(test_lcd1602_reaches_ready_through_i2c_bus_and_renders_with_diffing);
    RUN_TEST(test_lcd1602_adapter_requires_bus_dependency_and_validates_address);
    ...
    RUN_TEST(test_lcd2004_reaches_ready_through_i2c_bus_and_renders_four_rows);
    RUN_TEST(test_lcd2004_adapter_requires_bus_dependency);
    RUN_TEST(test_lcd1602_pin_config_codec_json_and_validation);
    RUN_TEST(test_lcd1602_pin_type_and_api_adapter_are_registered);
    RUN_TEST(test_lcd1602_pin_reaches_ready_without_dependency_and_renders_correct_bytes);
    RUN_TEST(test_lcd1602_pin_migrated_config_without_pins_faults);
    RUN_TEST(test_lcd2004_pin_config_codec_json_and_validation);
    RUN_TEST(test_lcd2004_pin_type_and_api_adapter_are_registered);
    RUN_TEST(test_lcd2004_pin_sends_correct_ddram_row_addresses);
    RUN_TEST(test_lcd2004_pin_reaches_ready_without_dependency_and_renders_correct_bytes);
    ...
    RUN_TEST(test_pixel_strip_brightness_percent_helpers_round_trip);
    RUN_TEST(test_pixel_strip_config_round_trip_and_validation);
    RUN_TEST(test_pixel_strip_config_rejects_pixel_count_out_of_bounds);
    RUN_TEST(test_pixel_strip_buffer_set_fill_and_read_back_are_bounded);
    RUN_TEST(test_pixel_strip_show_fails_before_hardware_is_ready);
    RUN_TEST(test_pixel_strip_set_output_changes_live_brightness_not_config);
    RUN_TEST(test_pixel_strip_set_output_on_off_gates_without_changing_brightness);
    RUN_TEST(test_pixel_strip_rejects_invalid_on_payload);
    RUN_TEST(test_pixel_strip_restores_retained_on_state_on_reboot);
    RUN_TEST(test_pixel_strip_restores_retained_brightness_on_reboot);
    RUN_TEST(test_pixel_strip_ignores_retained_brightness_when_restore_disabled);
    RUN_TEST(test_pixel_strip_type_and_api_adapter_are_registered);
    RUN_TEST(test_pixel_strip_api_adapter_schema_smoke);
    RUN_TEST(test_pixel_effect_solid_fills_target_strip_on_start);
    RUN_TEST(test_pixel_effect_solid_set_output_changes_live_color_not_config);
    RUN_TEST(test_pixel_effect_solid_set_output_on_off_gates_without_changing_color);
    RUN_TEST(test_pixel_effect_solid_rejects_invalid_on_payload);
    RUN_TEST(test_pixel_effect_solid_restores_retained_on_state_on_reboot);
    RUN_TEST(test_pixel_effect_solid_restores_retained_color_on_reboot);
    RUN_TEST(test_pixel_effect_solid_is_dependency_blocked_without_target);
    RUN_TEST(test_pixel_effect_solid_type_and_api_adapter_are_registered);
    RUN_TEST(test_pixel_effect_solid_api_adapter_schema_smoke);
    RUN_TEST(test_pixel_effect_alert_stays_black_with_no_condition_attached);
    RUN_TEST(test_pixel_effect_alert_toggles_at_blink_interval_while_condition_active);
    RUN_TEST(test_pixel_effect_alert_inverted_condition);
    RUN_TEST(test_pixel_effect_alert_type_and_api_adapter_are_registered);
    RUN_TEST(test_pixel_effect_alert_api_adapter_schema_smoke);
    return UNITY_END();
}
