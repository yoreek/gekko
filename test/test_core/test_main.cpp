...
int main(int, char**) {
    ...
    RUN_TEST(test_default_config_has_default_board_model);
    RUN_TEST(test_config_store_save_board_model_persists_across_reload);
    RUN_TEST(test_config_store_resets_out_of_range_board_model_to_default);
