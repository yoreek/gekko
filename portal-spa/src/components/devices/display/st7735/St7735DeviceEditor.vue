<template>
  <div class="device-type-stack">
    ...
    <section v-if="device && config" class="device-type-section">
      <v-row class="device-type-section__grid">
        <v-col cols="12" md="6">
          <v-text-field :label="t('device.fields.spiBusDeviceId')" :model-value="(config as any).spiBusDeviceId" readonly />
        </v-col>
        <v-col cols="12" md="6">
          <v-text-field :label="t('device.fields.chipSelectPin')" :model-value="(config as any).chipSelectPin" readonly />
        </v-col>
        <v-col cols="12" md="6">
          <v-text-field :label="t('device.fields.dcPin')" :model-value="(config as any).dcPin" readonly />
        </v-col>
        <v-col cols="12" md="6">
          <v-text-field :label="t('device.fields.resetPin')" :model-value="(config as any).resetPin" readonly />
        </v-col>
        <v-col cols="12" md="6">
          <v-text-field :label="t('device.fields.display.width')" :model-value="(config as any).width" readonly />
        </v-col>
        <v-col cols="12" md="6">
          <v-text-field :label="t('device.fields.display.height')" :model-value="(config as any).height" readonly />
        </v-col>
        <v-col cols="12" md="6">
...
const config = computed(() => props.device ? new St7735Device().normalizeConfig(props.device.config) : null)
