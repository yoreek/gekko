<template>
  <div class="d-flex flex-column ga-4">
    ...
    <v-row>
      <v-col cols="12">
        <v-text-field
          :label="t('device.fields.lcd2004Line1')"
          :model-value="modelValue.line1"
          maxlength="20"
          counter
          :readonly="mode === 'view'"
          :disabled="busy && mode !== 'view'"
          @update:model-value="update('line1', $event.slice(0, 20))"
        />
      </v-col>
      <v-col cols="12">
        <v-text-field
          :label="t('device.fields.lcd2004Line2')"
          :model-value="modelValue.line2"
          maxlength="20"
          counter
          :readonly="mode === 'view'"
          :disabled="busy && mode !== 'view'"
          @update:model-value="update('line2', $event.slice(0, 20))"
        />
      </v-col>
      <v-col cols="12">
        <v-text-field
          :label="t('device.fields.lcd2004Line3')"
          :model-value="modelValue.line3"
          maxlength="20"
          counter
          :readonly="mode === 'view'"
          :disabled="busy && mode !== 'view'"
          @update:model-value="update('line3', $event.slice(0, 20))"
        />
      </v-col>
      <v-col cols="12">
        <v-text-field
          :label="t('device.fields.lcd2004Line4')"
          :model-value="modelValue.line4"
          maxlength="20"
          counter
          :readonly="mode === 'view'"
          :disabled="busy && mode !== 'view'"
          @update:model-value="update('line4', $event.slice(0, 20))"
        />
      </v-col>
    </v-row>
