export default {
  ...
  device: {
    ...
    dialog: {
      ...
      ds18b20NoDependency: 'Перед добавлением DS18B20 создайте зависимость OneWire.',
      ds18b20AddressHint: 'Используйте 16-символьный ROM-адрес из сканирования OneWire.',
      ds18b20AddressInvalid: 'Введите 16-символьный шестнадцатеричный ROM-адрес.',
      ds18b20ScanAction: 'Сканировать зависимость',
      ds18b20Resolution: '{value}-бит',
      thermostatNoTemperatureSensor: 'Сначала подключите датчик температуры DS18B20.',
      thermostatNoSwitch: 'Сначала подключите GPIO выключатель.',
      thermostatMode: {
        off: 'Выключен',
        heat: 'Нагрев',
        cool: 'Охлаждение',
