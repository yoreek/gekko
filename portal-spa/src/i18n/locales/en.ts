export default {
  ...
  device: {
    ...
    dialog: {
      ...
      ds18b20NoDependency: 'Create a OneWire dependency before adding a DS18B20 sensor.',
      ds18b20AddressHint: 'Use the 16-character ROM address from a OneWire scan.',
      ds18b20AddressInvalid: 'Enter a 16-character hexadecimal ROM address.',
      ds18b20ScanAction: 'Scan dependency',
      ds18b20Resolution: '{value}-bit',
      thermostatNoTemperatureSensor: 'Create or connect a DS18B20 temperature sensor before configuring the thermostat.',
      thermostatNoSwitch: 'Create or connect a GPIO switch before configuring the thermostat.',
      thermostatMode: {
        off: 'Off',
        heat: 'Heat',
        cool: 'Cool',
