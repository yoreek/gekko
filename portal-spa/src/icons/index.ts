import {
  ...
  mdiWaterPump as waterPumpPath,
  mdiMonitor as monitorPath,
  mdiTransitConnectionHorizontal as transitConnectionHorizontalPath,
  mdiSwapHorizontal as swapHorizontalPath,
  mdiCableData as cableDataPath,
  mdiChip as chipPath,
  mdiThermostat as thermostatPath,
  mdiFire as firePath,
  mdiSnowflake as snowflakePath,
  mdiSineWave as sineWavePath,
  mdiCheckCircleOutline as checkCircleOutlinePath,
  mdiAlertOutline as alertOutlinePath,
  mdiBellOutline as bellOutlinePath,
  mdiRefresh as refreshPath,
  mdiUpload as uploadPath,
  mdiTrashCan as trashPath,
  mdiFlashOutline as flashOutlinePath,
  mdiLedStrip as ledStripPath,
} from '@mdi/js'
...
> = {
  ...
  time: createIconShape(['M12 4a8 8 0 100 16 8 8 0 000-16z', 'M12 8v4l3 2']),
...
> = {
  ...
  pump: createFilledIconShape(waterPumpPath),
  display: createFilledIconShape(monitorPath),
  'bus-i2c': createFilledIconShape(transitConnectionHorizontalPath),
  'bus-spi': createFilledIconShape(swapHorizontalPath),
  'bus-onewire': createFilledIconShape(cableDataPath),
  chip: createFilledIconShape(chipPath),
  thermostat: createFilledIconShape(thermostatPath),
  ...
  'pixel-strip': createFilledIconShape(ledStripPath),
