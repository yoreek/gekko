              ...
              <v-sheet border rounded class="pa-3 d-flex flex-column ga-3 h-100">
                <div>
                  ...
                  <v-row density="compact" align="center" no-gutters>
                    ...
                    <v-col v-if="display.supportsColor" cols="12" class="mt-2">
                      <DisplayColorField
                        :label="t('device.dialog.display.backgroundColor')"
                        :model-value="layout?.backgroundColor ?? '#000000'"
...
import DisplayColorField from '@/components/devices/display/DisplayColorField.vue'
