  ...
  <PageContainer dense>
    <PageCard>
      ...
      <v-row density="comfortable" class="ga-4">
        <!-- Canvas Panel -->
        <v-col cols="12" md="4">
          <v-sheet border rounded class="pa-3" style="background: #000; aspect-ratio: 1/2">
            <svg width="100%" height="100%" viewBox="0 0 128 64" style="background: #1a1a1a; border: 1px solid #333">
              <!-- Widget boxes -->
