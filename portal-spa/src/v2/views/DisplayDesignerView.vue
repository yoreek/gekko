...
import DisplayDesignerCanvas from '@/v2/components/devices/display/DisplayDesignerCanvas.vue'
import DisplayDesignerInspector from '@/v2/components/devices/display/DisplayDesignerInspector.vue'
import { useDisplayDesigner, type DisplayDesignerConfig } from '@/v2/composables/useDisplayDesigner'
