...
const shots: Array<{ name: string; path: string; fullPage?: boolean }> = [
  ...
  { name: 'device-htu21', path: '/devices/670845766' },
  ...
  { name: 'device-pcf8574-expander', path: '/devices/670845760' },
  { name: 'device-port-expander-switch', path: '/devices/670845762' },
  { name: 'device-ads1115-hub', path: '/devices/670845794' },
  { name: 'device-cd74hc4067-hub', path: '/devices/670845797' },
  { name: 'device-analog-input-channel', path: '/devices/670845795' },
  { name: 'device-ntc-thermistor', path: '/devices/670845758' },
