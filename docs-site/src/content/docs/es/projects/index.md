---
title: Proyectos
description: Empiece por el resultado y siga el cableado, el grafo de dispositivos, el orden de configuración y la verificación.
sidebar:
  order: 0
---

Estas guías empiezan por un resultado práctico en vez de un tipo técnico. Cada
una incluye hardware, grafo de Gekko, orden de creación y una comprobación segura.
