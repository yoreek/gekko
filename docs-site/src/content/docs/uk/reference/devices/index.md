...
description: Усі 33 типи пристроїв, вбудовані в кожен образ прошивки Gekko.
sidebar:
  order: 1
...
| `lcd1602` | Символьний HD44780 LCD 16 × 2 через port-експандер PCF857x |
| `lcd2004` | Символьний HD44780 LCD 20 × 4 через port-експандер PCF857x |
