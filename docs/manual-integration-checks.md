...
- Build and flash `esp32dev_ble` — BLE provisioning is not compiled into the default `esp32dev` build.
...
- Build the default `esp32dev` and confirm the API reports BLE provisioning as
