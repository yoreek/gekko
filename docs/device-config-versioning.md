...
- [Device Registry: Type-specific config format migration](../openspec/specs/device-registry/spec.md)
- [Device Configuration](../openspec/specs/device-configuration/spec.md)
